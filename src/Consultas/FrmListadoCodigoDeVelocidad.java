 ...
 * @author Victor
 */
public class FrmListadoCodigoDeVelocidad extends javax.swing.JFrame {

    DefaultListModel modelo = new DefaultListModel();

    /**
     * Creates new form FrmCDV
     */
    public FrmListadoCodigoDeVelocidad() {
        initComponents();
        cargar();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(293, 71, 139, 248));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/KmH.png"))); // NOI18N
...
//            java.util.logging.Logger.getLogger(FrmListadoCodigoDeVelocidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new FrmListadoCodigoDeVelocidad().setVisible(true);
//            }
//        });
//    }
